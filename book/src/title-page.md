# The arbitrum-reth Book

*by nun and the arbitrum-reth contributors*

This version of the text documents `arbitrum-reth` 0.1.0, built against the pinned
`arbitrum-revm` and `arbitrum-alloy` revisions recorded in the workspace `Cargo.toml`.

> **Experimental software.** `arbitrum-reth` is not production infrastructure. Do not use
